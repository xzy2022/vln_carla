...
def main() -> int:
    ...
    # Required spawn transform:
    # position = (0.038, 15.320, 0.15), heading toward negative X half-axis.
    spawn_transform = carla.Transform(
        carla.Location(x=0.038, y=15.320, z=0.15),
    ...
    if vehicle_actor is None:
        print(
            "[error] failed to spawn vehicle at (x=0.038, y=15.320, z=0.15). "
